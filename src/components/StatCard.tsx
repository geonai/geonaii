...
export const StatCard = ({ icon: Icon, value, label, iconColor = "text-primary" }: StatCardProps) => {
  return (
    <div className="group relative bg-card border border-border rounded-lg p-6 hover:border-primary/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,198,255,0.15)]">
